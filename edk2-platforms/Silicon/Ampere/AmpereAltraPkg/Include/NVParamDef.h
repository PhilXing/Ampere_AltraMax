...
typedef enum {
  ...
  NV_PMPRO_REGION2_LOAD_END                 = NV_SI_ALTRAMAX_ICCMAX_OC_LIMIT_MARGIN,

  /* NOTE: Add before NV_MANU_PARAM_MAX and increase its value */
  NV_MANU_PARAM_MAX                         = (67 * 8) + NV_MANU_PARAM_START,
  ...
  NV_SI_RO_BOARD_DDR_S0_RTT_NOM                     = (58 * 8) + NV_BOARD_PARAM_START, /* Default: 0x71060177 */
  NV_SI_RO_BOARD_DDR_S1_RTT_NOM                     = (59 * 8) + NV_BOARD_PARAM_START, /* Default: 0x71060177 */
  NV_SI_RO_BOARD_DDR_S0_RTT_PARK                    = (60 * 8) + NV_BOARD_PARAM_START, /* Default: 0x70060070 */
  NV_SI_RO_BOARD_DDR_S1_RTT_PARK                    = (61 * 8) + NV_BOARD_PARAM_START, /* Default: 0x70060070 */
  ...
  NV_SI_RO_BOARD_S0_RCA7_CFG                        = (109 * 8) + NV_BOARD_PARAM_START, /* Default: 0x00030003 */
  ...
  NV_SI_RO_BOARD_S1_RCA4_CFG                        = (143 * 8) + NV_BOARD_PARAM_START, /* Default: 0x00030003 */
