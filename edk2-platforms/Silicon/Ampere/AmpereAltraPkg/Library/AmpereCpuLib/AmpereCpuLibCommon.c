...
UINT32 Ac02CoreOrderMonolithic[PLATFORM_CPU_MAX_CPM * PLATFORM_CPU_NUM_CORES_PER_CPM] = {
  36, 40, 52, 56, 32, 44, 48, 60,
  20, 24, 68, 72, 16, 28, 64, 76,
  4, 8, 84, 88, 0, 12, 80, 92,
  100, 104, 96, 108, 116, 120, 112, 124,
  38, 42, 54, 58, 34, 46, 50, 62,
  22, 26, 70, 74, 18, 30, 66, 78,
  6, 10, 86, 90, 2, 14, 82, 94,
  102, 106, 98, 110, 118, 122, 114, 126,
  37, 41, 53, 57, 33, 45, 49, 61,
  21, 25, 69, 73, 17, 29, 65, 77,
  5, 9, 85, 89, 1, 13, 81, 93,
  101, 105, 97, 109, 117, 121, 113, 125,
  39, 43, 55, 59, 35, 47, 51, 63,
  23, 27, 71, 75, 19, 31, 67, 79,
  7, 11, 87, 91, 3, 15, 83, 95,
  103, 107, 99, 111, 119, 123, 115, 127,
};

UINT32 Ac02CoreOrderHemisphere[PLATFORM_CPU_MAX_CPM * PLATFORM_CPU_NUM_CORES_PER_CPM] = {
  32, 48, 16, 64, 36, 52, 0, 20,
  68, 80, 4, 84, 96, 100, 112, 116,
  34, 50, 18, 66, 38, 54, 2, 22,
  70, 82, 6, 86, 98, 102, 114, 118,
  33, 49, 17, 65, 37, 53, 1, 21,
  69, 81, 5, 85, 97, 101, 113, 117,
  35, 51, 19, 67, 39, 55, 3, 23,
  71, 83, 7, 87, 99, 103, 115, 119,
  44, 60, 28, 76, 40, 56, 12, 24,
  72, 92, 8, 88, 108, 104, 124, 120,
  46, 62, 30, 78, 42, 58, 14, 26,
  74, 94, 10, 90, 110, 106, 126, 122,
  45, 61, 29, 77, 41, 57, 13, 25,
  73, 93, 9, 89, 109, 105, 125, 121,
  47, 63, 31, 79, 43, 59, 15, 27,
  75, 95, 11, 91, 111, 107, 127, 123,
};

UINT32 Ac02CoreOrderQuadrant[PLATFORM_CPU_MAX_CPM * PLATFORM_CPU_NUM_CORES_PER_CPM] = {
  16, 32, 0, 20, 36, 4, 84, 96,
  18, 34, 2, 22, 38, 6, 86, 98,
  17, 33, 1, 21, 37, 5, 85, 97,
  19, 35, 3, 23, 39, 7, 87, 99,
  48, 64, 52, 68, 80, 100, 112, 116,
  50, 66, 54, 70, 82, 102, 114, 118,
  49, 65, 53, 69, 81, 101, 113, 117,
  51, 67, 55, 71, 83, 103, 115, 119,
  28, 44, 12, 24, 40, 8, 88, 108,
  30, 46, 14, 26, 42, 10, 90, 110,
  29, 45, 13, 25, 41, 9, 89, 109,
  31, 47, 15, 27, 43, 11, 91, 111,
  60, 76, 56, 72, 92, 104, 124, 120,
  62, 78, 58, 74, 94, 106, 126, 122,
  61, 77, 57, 73, 93, 105, 125, 121,
  63, 79, 59, 75, 95, 107, 127, 123,
};
